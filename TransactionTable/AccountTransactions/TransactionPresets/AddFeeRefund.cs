...
namespace PortfolioPerformanceTableHelper
{
    public partial class AccountTransactionsTable : TransactionsTable
    {
        ...
        /// </remarks>
        public void AddFeeRefund(DateTime feeDate, DepositAccount cashAccount, double amount, Objects.Security? security = null, string? note = null)
        {
            AddFeeRefund(feeDate, cashAccount, (decimal)amount, security, note);
        }
        /// <summary>
        /// Adds a fee transaction to the Account Transactions table.
        /// </summary>
